...
//Public Methods
	...
	public static void match()
	{
		...
		else
		{
			...
			a = lm.match(thresh);
			System.out.println(a.size() + " after lexical matching");
			
			// Michelle TODO
			CommentMatcher cm = new CommentMatcher();
			a.addAll(cm.match(thresh));
			System.out.println(a.size() + " after comment matching");
		}
...
//			else
				a.addAll(aux);
			System.out.println(a.size() + " after string matching");
		}
